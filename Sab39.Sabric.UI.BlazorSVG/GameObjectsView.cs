...
/// <summary>
/// Renders every object in a game.
/// </summary>
/// <remarks>
/// Closed here rather than left as <c>&lt;ItemListViewBase TItem="GameObjectBase" ... /&gt;</c> at
/// the call site, because inference would take TItem from whatever the game's list is typed as -
/// AetherGameObjectBase, say - and then ask for an <c>IItemView</c> of that. MS.DI does no variance
